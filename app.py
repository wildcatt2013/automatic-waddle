...
MOOD_COLORS = {
    'red': 'Праздничное, восторженное настроение',
    'orange': 'Радостное, теплое настроение',
    'yellow': 'Светлое, приятное настроение',
    'green': 'Спокойное, уравновешенное настроение',
    'blue': 'Грустное, тоскливое настроение',
    'purple': 'Тревожное, напряженное настроение',
    'black': 'Упадок сил, полное уныние'
}
